% ============================================================
%  step1.tex  –  products
%  Compile with: pdflatex step1.tex
% ============================================================
...
\begin{tikzpicture}
  ...
  \node[anchor=south west, inner sep=0] (img) at (0,0)
      {\includegraphics[width=\textwidth]{products.pdf}};
  ...
  % Badge 1: TODO – point to the relevant click target
  \node[badge] (b1) at \ip{0.50}{0.50} {1};
  \draw[arrow] (b1) -- \ip{0.45}{0.50};
